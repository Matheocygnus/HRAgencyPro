  ...
  if (!hero) {
    return (
      <div className="flex flex-col gap-4 p-4 md:p-6" data-testid="hero-detail-not-found">
        ...
        <Button variant="flat" size="sm" startContent={<ArrowLeft className="size-4" />} onPress={() => navigate({ to: '/heroes' })}>
          Back to Heroes
        </Button>
      </div>
    )
  ...
  return (
    <div data-testid="hero-detail" className="flex flex-col gap-4 p-4 md:gap-6 md:p-6">
      ...
      <div className="flex items-center gap-3">
        <Button variant="flat" size="sm" isIconOnly aria-label="Back" onPress={() => navigate({ to: '/heroes' })}>
